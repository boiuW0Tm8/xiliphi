...
// It resets only on a hard browser refresh.
...
export default function AlmanacBookAnimation({
  ...
  useEffect(() => {
    ...
    // 2. Check the global variable instead of sessionStorage
    ...
    const t4 = setTimeout(() => {
      setPhase("done");
      // 3. Set it to true so it doesn't play again during this JS lifecycle
  ...
  return createPortal(
    <div
      style={{
        ...
        // Using a slightly snappier 0.5s ease-out for the exit
      ...
      >
        ...
        <div
          style={{
            ...
            transition: "opacity 0s 0.8s", // Syncing with the cover flip
          }}
        />
